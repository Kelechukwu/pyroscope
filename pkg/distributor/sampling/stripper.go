...
func NewStripper(ruler Ruler) *Stripper {
	return &Stripper{ruler: ruler}
}
...
func (s *Stripper) Strip(tenantID string, seriesLabels phlaremodel.Labels, p *profilev1.Profile) {
