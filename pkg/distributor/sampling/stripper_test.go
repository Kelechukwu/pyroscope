...
// TestStripper_Strip_Overview is a readable, end-to-end reference for Strip. It
...
func TestStripper_Strip_Overview(t *testing.T) {
	in := []sampleView{
	...
	p := buildProfile(in)
	NewStripper(ruler).Strip("tenant-a", phlaremodel.LabelsFromStrings(phlaremodel.LabelNameServiceName, "checkout"), p)
...
func TestStripper_Strip(t *testing.T) {
	p := stripTestProfile()
	NewStripper(nil).Strip("", nil, p)
...
func TestStripper_Strip_NoSamples(t *testing.T) {
	p := stripTestProfile()
	p.Sample = nil
	NewStripper(nil).Strip("", nil, p)
...
func TestStripper_Strip_AllSamplesInvalid(t *testing.T) {
	p := stripTestProfile()
...
func TestStripper_Strip_SampleLabels(t *testing.T) {
	p := stripTestProfile()
...
// symbols, re-interned.
func TestStripper_Strip_KeepsTargetedFunction(t *testing.T) {
	p := stripTestProfile()
	ruler := fakeRuler{rules: map[string][]*phlaremodel.RecordingRule{
...
func TestStripper_Strip_RulesNoMatch(t *testing.T) {
	p := stripTestProfile()
	ruler := fakeRuler{rules: map[string][]*phlaremodel.RecordingRule{
...
func TestStripper_Strip_DeferredSampleLabelMatcher(t *testing.T) {
...
func TestStripper_Strip_TotalsSplitByNonFunctionRuleLabel(t *testing.T) {
...
func TestStripper_Strip_TotalsMatcherGatesLabelKeep(t *testing.T) {
	// String table: region=3, eu=4, us=5.
	p := &profilev1.Profile{
		SampleType:  []*profilev1.ValueType{{Type: 1, Unit: 2}},
		StringTable: []string{"", "samples", "count", regionLabel, "eu", "us"},
...
func TestStripper_Strip_TotalsNotEqualMatcherKeepsLabel(t *testing.T) {
	// String table: region=3, eu=4, us=5.
	p := &profilev1.Profile{
		SampleType:  []*profilev1.ValueType{{Type: 1, Unit: 2}},
		StringTable: []string{"", "samples", "count", regionLabel, "eu", "us"},
...
func TestStripper_Strip_KeptSampleCarriesTotalRuleLabels(t *testing.T) {
...
func TestStripper_Strip_NoAliasedLabelCapacity(t *testing.T) {
