...
func (s *Stripper) computeExceptions(tenantID string, seriesLabels phlaremodel.Labels, p *profilev1.Profile) map[uint64][]deferredRule {
...
func (s *Stripper) targetedFunctions(tenantID string, seriesLabels phlaremodel.Labels, p *profilev1.Profile) map[string][]deferredRule {
	if s.ruler == nil {
		return nil
	}
